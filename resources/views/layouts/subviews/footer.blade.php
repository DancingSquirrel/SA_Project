        ...
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 my-4 w-full xl:w-1/5">
            <a href="/" class="block w-56 mb-10">
              <img src="https://www.iconhome.co.th/media/website/IMG-1617358662942.png" alt="">
            </a>
            <p class="text-justify">
            Copyright 2022 
            <p>
            Iconhome Real Estate Co., Ltd.
            </p>
          ...
          <div class="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            ...
            <a href="https://www.facebook.com/iconhomeclub" class="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-blue-400 hover:border-blue-400">
            ...
            <a href="https://www.youtube.com/@iconhome3518" target="_blank" class="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full hover:text-blue-400 hover:border-blue-400">
