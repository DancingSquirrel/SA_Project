    ...
    <div class="flex justify-between w-full">
        ...
        <div class="hidden md:flex md:items-center md:w-full" id="menu">
            <ul class="w-full md:flex items-center justify-center text-base text-gray-700 pt-4 md:pt-0">
                <li><a class="md:p-4 py-3 px-2 block" href="{{route('admin.realEstateList')}}">หน้าแรก</a></li>
                <li><a class="md:p-4 py-3 px-2 block" href="{{route('user.index')}}">ฝากขายบ้านกับเราฟรี</a></li>
        ...
        <a href="{{route('setting.index')}}"
            class="relative px-7 py-3 m-3 overflow-hidden font-medium text-gray-600 bg-gray-100 border border-gray-100 rounded-lg shadow-inner group">
            <span
        ...
        <a href="#_"
            class="relative px-7 py-3 m-3 overflow-hidden font-medium text-red-600 bg-red-100 border border-red-100 rounded-lg shadow-inner group">
            <span
