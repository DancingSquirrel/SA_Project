                                ...
                                <div class="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
                                    ...
                                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                        <span class="absolute top-1/2 left-1/2 text-2xl font-semibold text-white -translate-x-1/2 -translate-y-1/2 sm:text-3xl">First
                                            Slide</span>
                                        <img src="{{asset($image_path) }}" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                                    </div>
                                    @endforeach
                                </div>
                                <!-- Slider indicators -->
                ...
                <div class="lg:pl-20 m-10">
                    <div class="mb-6 ">
                        ...
                        <h2 class="font-semibold leading-loose tracking-wide text-gray-500 md:text-sm">
                            ...
                            <div class="max-w-xl mt-6 mb-6 font-semibold leading-loose tracking-wide text-gray-500 md:text-sm"> 
                            <div>{{$realEstate->detail}}</div>
                            ตำบล:{{$realEstate->tambon}} อำเภอ:{{$realEstate->amphoe}} จังหวัด:{{$realEstate->province}} </div>
                                @elseif(!($realEstate->tambon) && $realEstate->amphoe)
                                <div class="max-w-xl mt-6 mb-6 font-semibold leading-loose tracking-wide text-gray-500 md:text-sm"> 
                                <div>{{$realEstate->detail}}</div>   
                                อำเภอ:{{$realEstate->amphoe}} จังหวัด:{{$realEstate->province}}</div>
                                @else
                                <div class="max-w-xl mt-6 mb-6 font-semibold leading-loose tracking-wide text-gray-500 md:text-sm">
                                <div>{{$realEstate->detail}}</div>    
                                จังหวัด:{{$realEstate->province}}</div>
                                @endif
                                        ...
                                        <div class="w-full mb-4 md:w-2/5">
                                            <div class="flex ">
                                                <span class="mr-3 text-gray-500 ">
                                                    ...
                                                    <svg class="bi bi-diagram-3 w-7 h-7" fill="#000000" height="200px" width="200px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve">
                                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                        <g id="SVGRepo_iconCarrier">
                                                            <g>
                                                                <g>
                                                                    <path d="M105.739,244.87v166.957h300.522V244.87H105.739z M256,378.435H155.826c-9.217,0-16.696-7.479-16.696-16.696 s7.479-16.696,16.696-16.696H256c9.217,0,16.696,7.479,16.696,16.696S265.217,378.435,256,378.435z M356.174,311.652H155.826 c-9.217,0-16.696-7.479-16.696-16.696c0-9.217,7.479-16.696,16.696-16.696h200.348c9.217,0,16.696,7.479,16.696,16.696 C372.87,304.174,365.391,311.652,356.174,311.652z"></path>
                                                                </g>
                                                            </g>
                                                            <g>
                                                                <g>
                                        ...
                                        <div class="w-full mb-4 md:w-2/5">
                                            <div class="flex ">
                                                ...
                                                <div>
                                                    ...
                                                    <h2 class="text-base font-semibold text-gray-700 ">
                                                        {{$realEstate->bathroom}} ห้อง
                                                    </h2>
                                                </div>
                                            </div>
                                        </div>
                                        @endif
                                        @if($realEstate->bedroom)
                                        <!-- 4 -->
                                        <div class="w-full mb-4 md:w-2/5">
                                            <div class="flex ">
                                                <span class="mr-3 text-gray-500 ">
                                                    <svg fill="#000000" class="bi bi-gpu-card w-7 h-7" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" width="64px" height="64px">
                                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                        <g id="SVGRepo_iconCarrier">
                                                            <g>
                    ...
                    <div role="listitem" class="border-gray-200 border-t border-b xl:w-full sm:w-3/4 md:w-2/5 relative sm:mb-24 xl:max-w-sm lg:w-2/5">
                        <div class="rounded overflow-hidden shadow-md bg-white mt-10">
                            <div class="absolute -mt-20 w-full flex justify-center">
                                <div class="h-32 w-32">
                                    <img src="{{ URL::asset($realEstate->user()->get()->first()->image_path) }}" alt="Display Picture of Andres Berlin" role="img" class="rounded-full object-cover h-full w-full shadow-md">
                                </div>
                            </div>
