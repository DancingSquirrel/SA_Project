...
<div class="animate-fade-down flex-col w-full p-2">
    <div class="flex-shrink max-w-full px-4 w-full">
        <p class="text-4xl text-gray-900 font-poppin mt-3 mb-5">Create RealEstate</p>
    </div>
    <!-- start -->
    ...
    <div class="flex-shrink p-4 mb-4">
        <div class="flex flex-col justify-center bg-white  rounded-lg h-full">
            <div class="p-4 mb-4 bg-white rounded-lg">
                <form action="{{ route('admin.createRealEstate.make') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="grid grid-cols-6 gap-6 font-poppin">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <div class="grid grid-cols-4 gap-6">
                                ...
                                <div class="alert-danger bg-white sm:col-span-2">
                                    <p class="text-xs text-rose-700">*{{$errors->first('address')}} </p>
                                </div>
                                @endif
                            </div>

                            <input placeholder="address" class="peer w-full border-b border-blue-gray-200 bg-transparent font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border-blue-gray-200 focus:border-pink-500 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50" name="address" id="address" />
                        ...
                        <div class="col-span-6 sm:col-span-3 grid grid-cols-3 gap-4 border border-gray-200 p-2 rounded">
                            ...
                            <label for="input_province" class="block mb-2  text-lg font-medium text-gray-900 ">Detail Address </label>
                            @if($errors->first('input_province'))
                            <div class="alert-danger bg-white sm:col-span-2">
                                <p class="text-xs text-rose-700">*{{$errors->first('input_province')}} </p>
                            </div>
                            @else
                            <div></div>
                            <div></div>
                            ...
                            <!-- 1 -->
                            <select id="input_province" name="input_province" class=" appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <!-- 2 -->
                            <select id="input_amphoe" name="input_amphoe" class=" appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <!-- 3 -->
                            <select id="input_tambon" name="input_tambon" class=" appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        ...
                        <div class="col-span-6 sm:col-span-3 grid grid-cols-3 gap-4 border border-gray-200 p-2 rounded">
                            <label for="input_province" class="block mb-2  text-lg font-medium text-gray-900 ">Detail RealEstate</label>
                            @if($errors->first('input_type_real_estate'))
                            <div class="alert-danger bg-white sm:col-span-2">
                                <p class="text-xs text-rose-700">*{{$errors->first('input_type_real_estate')}} </p>
                            </div>
                            @elseif($errors->first('input_bedroom'))
                            <div class="alert-danger bg-white sm:col-span-2">
                                <p class="text-xs text-rose-700">*{{$errors->first('input_bedroom')}} </p>
                            </div>
                            @elseif($errors->first('input_bathroom'))
                            <div class="alert-danger bg-white sm:col-span-2">
                                <p class="text-xs text-rose-700">*{{$errors->first('input_bathroom')}} </p>
                            </div>
                            @else
                            <div></div>
                            <div></div>
                            ...
                            <!-- 1 -->
                            <select id="input_type_real_estate" name="input_type_real_estate" class=" appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <!-- 2 -->
                            <select id="input_bedroom" name="input_bedroom" class=" appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <!-- 3 -->
                            <select id="input_bathroom" name="input_bathroom" class=" appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <div class="grid grid-cols-4 gap-6">
                                <label for="input_province" class="block mb-2  text-lg font-medium text-gray-900 ">Area</label>
                                @if($errors->first('area'))
                                <div class="alert-danger bg-white sm:col-span-2">
                                    <p class="text-xs text-rose-700 ">*{{$errors->first('area')}} </p>
                                </div>
                                @endif
                            </div>

                            <input placeholder="sq m." class="peer w-full border-b border-blue-gray-200 bg-transparent  font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border-blue-gray-200 focus:border-pink-500 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50" name="area" id="area" type="number" />
                        </div>
                        <div class="col-span-6 row-span-2 sm:col-span-3 mt-2">
                            <div class="grid grid-cols-4 gap-6">
                                ...
                                <div class="alert-danger bg-white sm:col-span-2">
                                    <p class="text-xs text-rose-700">*{{$errors->first('detail')}} </p>
                                </div>
                                @endif
                            </div>

                            <textarea id="detail" name="detail" rows="7" placeholder="text here" class="block w-full rounded-md border border-gray-300 focus:border-indigo-600 py-2 px-3 text-gray-900 placeholder-gray-400 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-5"></textarea>
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                            <div class="grid grid-cols-4 gap-6">
                                ...
                                <div class="alert-danger bg-white sm:col-span-2">
                                    <p class="text-xs text-rose-700">*{{$errors->first('price')}} </p>
                                </div>
                                @endif
                            </div>

                            <input placeholder="bath" type="number" class="peer w-full border-b border-blue-gray-200 bg-transparent font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border-blue-gray-200 focus:border-pink-500 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50" name="price" id="price" />
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                            <div class="grid grid-cols-4 gap-6">
                                <label for="date_expired" class=" col-span-2 block mb-2  text-lg font-medium text-gray-900 ">Assigned to Staff</label>

                                @if($errors->first('staff_id'))
                                <div class="alert-danger bg-white sm:col-span-2">
                                    <p class="text-xs text-rose-700">*{{$errors->first('staff_id')}} </p>
                                </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <div class="grid grid-cols-4 gap-6">
                                <label for="date_start" class="col-span-2 block mb-2  text-lg font-medium text-gray-900 ">Date Start
                                    Agreement</label>
                                @if($errors->first('date_start'))
                                <div class="alert-danger bg-white sm:col-span-2">
                                    <p class="text-xs text-rose-700">*{{$errors->first('date_start')}} </p>
                                </div>
                                @endif
                            </div>
                            <input placeholder="DD/MM/YYYY" class="peer w-full border-b border-blue-gray-200 bg-transparent  font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border-blue-gray-200 focus:border-pink-500 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50" name="date_start" id="date_start" type="date" />
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                            <div class="grid grid-cols-4 gap-6">
                            ...
                            <select id="years_agreement" name="years_agreement" type="number" class=" appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        ...
                        <a href="{{route('admin.createRealEstate')}}" class="col-span-6 sm:col-span-1 relative px-7 py-3 m-3 overflow-hidden font-medium text-red-600 bg-red-100 border border-red-100 rounded-lg shadow-inner group">
