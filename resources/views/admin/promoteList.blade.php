                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr class="bg-gray-100">
                                                ...
                                                <th class="hidden lg:table-cell" data-sortable="">
                                                    <a href="#" class="dataTable-sorter mx-5">Promote Start </a>
                                                </th>
                                                <th class="text-center" data-sortable="false">
                                                    <p class="text-center dataTable-sorter mx-10">Promote Expired</p>
                                                </th>
                                                <th class="text-center" data-sortable="false">
                                                    <p class="text-center dataTable-sorter mx-10">Type</p>
                                                </th>
                                                <th class="text-center" data-sortable="false">
                                                    <p class="text-center dataTable-sorter mx-10">Facbook</p>
                                                </th>
                                                <th data-sortable="">
                                                    <a href="#" class="dataTable-sorter mx-5">Dhome</a>
                                                </th>
                                                <th data-sortable="">
                                                    <a href="#" class="dataTable-sorter mx-5">Shoppee</a>
                                                </th>
                                                <th data-sortable="">
                                                    <a href="#" class="dataTable-sorter mx-5">Google</a>
                                                </th>
                                                <th class="text-center" data-sortable="false">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center hidden lg:table-cell">{{ $realEstate->advertisements()->get()->first()->ad_start}}
                                                </td>
                                                <td class="text-center hidden lg:table-cell">{{ $realEstate->advertisements()->get()->first()->ad_expired}}
                                                </td>
                                                <td class="text-center hidden lg:table-cell">{{ $realEstate->type}}
                                                </td>
                                                <td class="flex text-center hidden lg:table-cell ">
                                                    <a class="flex justify-center" href="{{$realEstate->advertisements()->where('name', 'facbook')->get()->first()->URL}}">
                                                    <svg class="flex justify-items-center  h-10" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24" id="facebook"><path d="M20.9,2H3.1A1.1,1.1,0,0,0,2,3.1V20.9A1.1,1.1,0,0,0,3.1,22h9.58V14.25h-2.6v-3h2.6V9a3.64,3.64,0,0,1,3.88-4,20.26,20.26,0,0,1,2.33.12v2.7H17.3c-1.26,0-1.5.6-1.5,1.47v1.93h3l-.39,3H15.8V22h5.1A1.1,1.1,0,0,0,22,20.9V3.1A1.1,1.1,0,0,0,20.9,2Z"></path></svg>
                                                    </a>
                                                </td>
                                                <td class="text-center flex justify-items-center hidden lg:table-cell">
